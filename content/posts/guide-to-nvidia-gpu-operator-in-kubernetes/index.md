...
> *This post was originally published on [InfraCloud's blog](https://www.infracloud.io/blogs/guide-to-nvidia-gpu-operator-in-kubernetes/). Co-authored with [Sameer Kulkarni](https://www.linkedin.com/in/sameer-kulkarni-9875773b/).*
...
![NVIDIA GPU Operator](nvidia-gpu-operator.webp)
...
![vGPU vs MIG vs Time-Slicing](vgpuvs-migvs-time-slicing.webp)
...
![GPUDirect RDMA: directly connecting GPUs over the network](gpu-direct-rdma.webp)
...
![Storage access pattern with and without GPUDirect Storage](storage-access-pattern.webp)
*([Storage access pattern with and without GPUDirect Storage](https://developer.nvidia.com/blog/boosting-data-ingest-throughput-with-gpudirect-storage-and-rapids-cudf/))*

## GDR Copy

![GPUDirect RDMA (GDR) Copy](gpudirect-rdma-copy.webp)
...
![Host-Device memory copy operation using cudaMemcpy and GDR Copy](host-device-memory-copy-operation.webp)
