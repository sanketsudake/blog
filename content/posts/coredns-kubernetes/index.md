...
categories = []
summary = "This post highlights observability, effective configuration and troubleshooting around CoreDNS, which is the default DNS service on Kubernetes."
canonicalURL = "https://www.infracloud.io/blogs/using-coredns-effectively-kubernetes/"
showTableOfContents = true
+++

> *This post was originally published on [InfraCloud's blog](https://www.infracloud.io/blogs/using-coredns-effectively-kubernetes/).*
...
- **[Error codes](https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-6) for requests**
...
![CoreDNS NXDomain reduction](coredns-rcode-nxdomain.png)
