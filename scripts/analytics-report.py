...
`source` first):
    ...
    GSC_SITE_URL      Search Console property, e.g. "https://ssudake.com/" or
                      "sc-domain:ssudake.com" (default: https://ssudake.com/).
...
Usage:
    analytics-report.py                       # last 28 days -> docs/analytics/<date>.{md,json}
    analytics-report.py --days 90
    analytics-report.py --property 123456789 --site https://ssudake.com/
...
def main():
    ...
    ap.add_argument("--out", default=None, help="markdown path, '-' for stdout (default docs/analytics/<date>.md)")
    args = ap.parse_args()

    load_local_env()
    property_id = args.property or os.environ.get("GA4_PROPERTY_ID")
    site_url = args.site or os.environ.get("GSC_SITE_URL", "https://ssudake.com/")
